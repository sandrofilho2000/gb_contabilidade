...
const Awards = () => {
  useGSAP(() => {
    gsap.utils.toArray('.awards .fadein').forEach((item: any) => {
      gsap.fromTo(
        item,
        { opacity: 0, y: -10 },
        {
  ...
  return (
    ...
    >
      <div className="container relative z-10 flex text-white">
        <GiTrophyCup className="text-6xl fadein" />
        <span className="text-center font-bold fadein uppercase text-white flex text-sm items-center">

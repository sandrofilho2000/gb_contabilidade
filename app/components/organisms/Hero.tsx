...
const Hero = () => {
  useGSAP(() => {
    gsap.to('.hero-center', { opacity: 1, y: -10 });
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="hero-center h-auto transform -translate-x-1/2 opacity-0 -translate-y-1/2 gap-4 flex flex-col items-center max-w-[340px] w-full text-center z-20 absolute top-1/2 left-1/2  text-white">
